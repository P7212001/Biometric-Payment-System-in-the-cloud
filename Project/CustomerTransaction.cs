    ...
    public partial class CustomerTransaction : Form
    {
        ...
        private void CustomerTransaction_Load(object sender, EventArgs e)
        {
           string u = CustomerLogin.a2;
            string b = "select CId from Customer where Email='" + u + "'";
            ...
            if (dd.Tables[0].Rows.Count > 0)
            {
                ...
                string w = "select TId,UserId,UserName,MerId,MerchantName,Amt,Date,Note From Trans where UserId='" + sss + "'";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string s1 = "select TId,UserId,UserName,MerId,MerchantName,Amt,Date,Note From Trans where Date>='" + dateTimePicker2.Text + "' AND Date<='" + dateTimePicker1.Text + "' and UserId='"+sss+"'";
